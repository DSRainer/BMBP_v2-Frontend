  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const bookingData = {
        ...
        notes: `Booking submitted via website form`
      }
    ...
    <div className={className}>
      <div className="p-6">
        <div className="mb-6">
          ...
          <h2 className="text-xl font-bold text-sidebar-foreground mb-1">{title}</h2>
          <p className="text-sidebar-foreground">{subtitle}</p>
        </div>

        <form onSubmit={handleSubmit} className="space-y-4 mb-6">
          <div>
            <label className="block text-sm font-medium text-sidebar-foreground mb-2">Full Name *</label>
            <Input 
              type="text"
          ...
          <div>
            <label className="block text-sm font-medium text-sidebar-foreground mb-2">Phone Number *</label>
            <Input 
              type="tel"
        ...
        {/* Selected Theme & Add-ons Display */}
              ...
              <div className="space-y-1">
                {getSelectedAddOnsData().map((addon) => (
                  <div key={addon.id} className="flex items-center justify-between text-sm">
                    <span className="text-sidebar-foreground">{addon.name}</span>
        ...
        <div className="border-t border-sidebar-border pt-4 mb-6">
          ...
          {selectedAddOns.length > 0 && (
            <div className="flex justify-between items-center mb-2">
              <span className="text-sidebar-foreground">Add-ons ({selectedAddOns.length})</span>
